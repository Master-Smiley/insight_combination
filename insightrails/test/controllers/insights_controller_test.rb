...
class InsightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create insight" do
    assert_difference('Insight.count') do
      post insights_url, params: { insight: { text: @insight.text, user_id: @insight.user_id } }
    end
  ...
  test "should update insight" do
    patch insight_url(@insight), params: { insight: { text: @insight.text, user_id: @insight.user_id } }
